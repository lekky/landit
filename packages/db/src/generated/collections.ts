...
export type SpotsSports = 'scooter' | 'skate';
export type SpotsStatus = 'pending' | 'live' | 'rejected';
export type StickersSport = 'scooter' | 'skate';
...
export type TricksSport = 'scooter' | 'skate';
...
export type UsersSports = 'scooter' | 'skate';
