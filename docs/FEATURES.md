...
- **No DOB stored**, no geolocation stored, no third-party map account (OpenFreeMap), no analytics
  wired (PostHog/Cloudflare are decided-but-unbuilt; Sentry is wired but inert without a DSN).
