...
export function EventsScreen({
  ...
  const fields = [
    ...
    { k: 'venue', label: 'Venue' },
    { k: 'town', label: 'Town' },
    { k: 'country', label: 'Country', placeholder: 'UK' },
    { k: 'address', label: 'Address', wide: true, placeholder: 'Full postal address, one line' },
    { k: 'phone', label: 'Phone', placeholder: 'As the venue publishes it' },
    {
      k: 'sourceUrl',
      label: 'Listing link',
      wide: true,
      placeholder: 'https://… the organiser’s own page',
    },
    { k: 'lat', label: 'Latitude', placeholder: 'Blank for no map pin' },
    { k: 'lng', label: 'Longitude', placeholder: 'Blank for no map pin' },
